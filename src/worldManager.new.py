...
class WorldManager(object):
    ...
    def draw(self, surface):
        ...
        #JTM self.sprite_positions.sort(sprite_compare)
        for sprite in self.sprite_positions:
            ...
            if spriteHeight < 1000:
                for stripe in range(drawStartX, drawEndX):
                    ...
                    sprite_rand = 0
                    if sprite[2] == 3:
                       jim_clock = jim_clock + 1
                       if jim_clock > 10000: 
                          jim_clock = 0
                          #jim_rand=random.randint(0,1)
                          jim_rand = jim_rand + 1
                          jim_rand = jim_rand % 2
                       sprite_rand = jim_rand
                    ...
                    if(transformY > 0 and stripe > 0 and stripe < w and transformY < zBuffer[stripe]):
                        surface.blit(pygame.transform.scale(self.sprites[sprite[2]+sprite_rand][texX], (1, spriteHeight)), (stripe, drawStartY))
